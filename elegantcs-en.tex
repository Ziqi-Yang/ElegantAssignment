\documentclass[lang=en,a4paper,bibend=bibtex]{elegantpaper}
...
\section*{Differences from ElegantPaper}
...
Also, the \lstinline[language=Bash]|echo inline| code example.
