...
\documentclass[lang=cn,a4paper]{elegantcs}

\title{ElegantCS: 一个优美的 \LaTeX{} 模板}
\author{Ziqi Yang}
\institute{\href{https://github.com/Ziqi-Yang/ElegantCS}{ElegantCS}}
...
以下是原\lstinline|ElegantPaper|文档, \lstinline|ElegantCS|与\lstinline|ElegantPaper|区别见\lstinline|elegantcs-en.pdf|文档。
